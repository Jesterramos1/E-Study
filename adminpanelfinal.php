...
<body>
    ...
    <ul class="nav-list" id="myTab" role="tablist">
      ...
      <li>
        <a href="#OlaPanel">
          ...
          <span class="links_name">OLA Response Settings</span>
        </a>
        <span class="tooltip">OLA Response Settings</span>
      </li>
      <li>
        <a href="#settingscon">
  ...
  <section class="home-section">
    ...
    <div class="page-container" id="OlaPanel">
      <div class="concon">
        <iframe src="admin_olasettings.php" frameborder="0"></iframe>
      </div>
    </div>
